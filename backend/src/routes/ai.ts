...
//         console.log(`🏎️  AI request from User ID: ${userId}`);
...
//             { userId: new mongoose.Types.ObjectId(req.user?.userId), text: prompt, role: 'user' },
//             { userId: new mongoose.Types.ObjectId(req.user?.userId), text: answer, role: 'ai' }
//         ]);
